...
| **Name**                                             | **Quantity** |
+======================================================+==============+
| [Ubuntu 22.04 Desktop                                | 1            |
| Image](https://releases.ubuntu.com/jammy/)           |              |
+------------------------------------------------------+--------------+
| [Zephyr Getting                                      | 1            |
| Started](https://docs.zephyrpr                       |              |
| oject.org/latest/develop/getting_started/index.html) |              |
+------------------------------------------------------+--------------+
| [Zephyr Software Development Kit                     | 1            |
| (SDK)](https://docs.zephyrproject.org/latest/deve    |              |
| lop/toolchains/zephyr_sdk.html#toolchain-zephyr-sdk) |              |
+------------------------------------------------------+--------------+
| [Infineon Customized                                 | 1            |
| OpenOCD](https://github.com/Infineon/openocd)        |              |
|                                                      | 1            |
| [ModusToolbox                                        |              |
| ](https://github.com/Infineon/training-modustoolbox) |              |
| (optional, includes Infineon's OpenOCD)              |              |
+------------------------------------------------------+--------------+
| hal\_infineon Binary Blobs (see instructions)        | 1            |
|                                                      |              |
| [VSCode](https://code.visualstudio.com/download)     | 1            |
|                                                      |              |
| [VSCode setup                                        | 1            |
| files](https://g                                     |              |
| ithub.com/lawrencek52/vscode-infineon-psoc6-openocd) |              |
+------------------------------------------------------+--------------+
...
![](media/image1.jpeg){width="0.5625in" height="0.5486111111111112in"}
